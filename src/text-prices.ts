...
export const MODEL_PRICES: Record<string, ProviderCost> = {
  ...
  "claude-mythos-preview": { input: 10, output: 50, cacheRead: 1 },
  ...
  "glm-5.2": { input: 1.4, output: 4.4, cacheRead: 0.28 },
  ...
  "grok-4.20-beta-0309-non-reasoning": { input: 1.25, output: 2.5, cacheRead: 0.2 },
  "grok-4.20-beta-0309-reasoning": { input: 1.25, output: 2.5, cacheRead: 0.2 },
  "grok-4.20-multi-agent-0309": { input: 1.25, output: 2.5, cacheRead: 0.2 },
  "grok-4.20-multi-agent-beta-0309": { input: 1.25, output: 2.5, cacheRead: 0.2 },
  ...
  "grok-4.5-latest": { input: 2, output: 6, cacheRead: 0.3 },
  ...
  "grok-code-fast-1-0825": { input: 1, output: 2, cacheRead: 0.2 },
